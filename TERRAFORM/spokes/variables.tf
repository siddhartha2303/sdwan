...
variable "vpn0_template_name" {
  type = string
}

variable "vpn0_template_description" {
  type = string
}

variable "vpn512_template_name" {
  type = string
}

variable "vpn512_template_description" {
  type = string
}

variable "ntp_template_name" {
  type = string
}
